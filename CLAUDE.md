...
The last `"power"` grant sits at **L52, not L55**: tier 5 opens at L50, and on this curve L55 is 630 days against L50's 300, so the tier's second power arrived more than twice as late as the tier itself. Every tier now completes within ~100 days of opening.
