...
const DEFS := {
	Id.CLASSIC: {
		...
		"powers": [Color("ef4444"), Color("2dd4bf"), Color("fde047"), Color("a3e635"),
			...
			Color("c2410c"), Color("0369a1"), Color("92400e"), Color("14b8a6"), Color("cbd5e1")],
	...
	Id.PIXEL_WARM: {
		...
		"powers": [Color("cc6a41"), Color("6b8f9b"), Color("e4b963"), Color("8ca271"),
			...
			Color("9c5a3c"), Color("4e7a91"), Color("7d5a3a"), Color("5f9a90"), Color("c3ccd6")],
	...
	Id.PIXEL_DARK: {
		...
		"powers": [Color("d0603a"), Color("5f7f8a"), Color("e8bc61"), Color("7c9166"),
			...
			Color("a85536"), Color("3f6f88"), Color("8a6136"), Color("4f8b82"), Color("aab6c4")],
